...
Recall that factorial is the product of an integer and all integers below it. Below are some examples.
```
factorial(1) = 1
factorial(2) = 2*1 = 2
factorial(3) = 3*2*1 = 6
...
```
Let's do a hands-on collaborative test writing exercise. Let's write unit tests for [this existing factorial function](src/main/java/tdd_workshop/unit_testing/exercise/Factorial.java). This function was generated by ChatGPT.
```java
